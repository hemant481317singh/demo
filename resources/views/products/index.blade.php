        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="col-sm-6">
                  <a class="btn btn-success btn-sm" href="{{ URL::route('products.create') }}">Add Product</a>
                </div>
                <div class="col-sm-6">
                </div>           
              </div>
          ...
          <div class="box-body">
            ...
            <table aria-describedby="example1_info" role="grid" id="example1" class="table table-bordered table-striped dataTable">
              <thead>
                <tr role="row">
                <th  style="width:  5%;" rowspan="1"  tabindex="0" >Sr. No.</th>
                <th  style="width: 20%;" rowspan="1"  tabindex="0">Code</th>
                <th  style="width: 15%;" rowspan="1"  tabindex="0">Image</th>
                <th  style="width: 15%;" rowspan="1"  tabindex="0">Category</th>
                <th  style="width: 15%;" rowspan="1"  tabindex="0">Product Type</th>
                <th  style="width: 10%;" rowspan="1"  tabindex="0">Status</th>
