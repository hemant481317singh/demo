        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="col-sm-6">
                  <a class="btn btn-success btn-sm" href="{{ URL::route('slider.create') }}">Add Slider</a>
                </div>
                <div class="col-sm-6">
                </div>           
              </div>
          ...
          <div class="box-body">
            ...
            <table aria-describedby="example1_info" role="grid" id="example1" class="table table-bordered table-striped dataTable">
              <thead>
                ...
                <th  style="width: 20%;" rowspan="1"  tabindex="0">Title</th>
                <th  style="width: 33%;" rowspan="1"  tabindex="0">Caption</th>
              ...
              <tbody>
                ...
                @foreach($slider as $key => $value)
                  ...
                  @endif
                    ...
                    <td>
                      <!-- Delete Button -->
                      {!! Form::open(array('url' => 'slider/' . $value->id, 'class' => 'pull-right')) !!}
                      {!! Form::hidden('_method', 'DELETE') !!}
                      {!! Form::submit('Delete', array('class' => 'btn btn-warning')) !!}
                      {!! Form::close() !!}
                      <!-- edit this role (uses the edit method found at GET /roles/{id}/edit -->
                      <!-- edit button -->
                      <a class="btn btn-small btn-info" href="{{ URL::to('slider/' . $value->id . '/edit') }}">Edit</a>            
                    </td>
                  </tr>
                  {{--*/ $count++ /*--}}
                @endforeach
